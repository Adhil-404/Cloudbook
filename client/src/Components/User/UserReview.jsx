                      ...
                      {editingReviewId === review.id ? (
                        <form
                          onSubmit={(e) => {
                            ...
                            setReviews(reviews.map(r =>
                              r.id === review.id
                                ? { ...r, title: editReview.title, comment: editReview.comment, rating: editReview.rating }
                                : r
                            ));
                        ...
                        >
                          <div className="rating-input">
                            {renderStars(editReview.rating, true, (star) => setEditReview({ ...editReview, rating: star }))}
                          </div>
